...
{
    char *path = "fz2cld:fz2cld:BAS:UPSA";
...
{
    char *path = "fz2cld:fz2cld:BAS:UPSA:ACC_01";
    rtdb_cli_list *nameList = NULL;
...
{
    char *path = "fz2cld:fz2cld:BAS:MD-Q1-201:GBZT";
    rtdb_cli_list *nameList = NULL;
...
{
    char *path = "fz2cld:fz2cld:BAS:UPSA:WD";
    rtdb_cli_list *nameList = NULL;
...
void test_mmulti_query_attributes(rtdb_cli* client)
{
    ...
    if(!paths) return ;
    rtdb_cli_list_push_tail(paths,"fz2cld:fz2cld:BAS:MD-Q1-201");
    rtdb_cli_list_push_tail(paths,"fz2cld:fz2cld:BAS:UPSA");
