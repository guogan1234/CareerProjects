 ...
 */
typedef void(rtdb_cli_table_notifier)(const char *tableName, int type, const rtdb_cli_list *records);
typedef void(rtdb_cli_node_notifier)(const char *nodePath, const rtdb_cli_record *record);
typedef void(rtdb_cli_exception_notifier)(int code);
