...
void test_node_notifier(const char *nodePath, const rtdb_cli_record *record)
{
...
void test_exception_notifier(int code)
{
    printf("test_exception_notifier , code : %d\n",code);
}
...
{       
    int code;
    int domainId = 1;
    const char *nodePath = "dlabel_01:slabel_01:proLabel_01:devLabel_01:dio_label_01";
...
{       
    ...
    if(!pathList) return ;
    rtdb_cli_list_push_tail(pathList,"dlabel_01:slabel_01:proLabel_01:devLabel_01:dio_label_01");
    rtdb_cli_list_push_tail(pathList,"dlabel_01:slabel_01:proLabel_01:devLabel_01:dio_label_02");
