!function(a, b, c, d) {
    ...
    function h(b, c, d) {
        b.element.find("option").each(function(e, f) {
            var g = a(f);
            g.data("original-index") === c && (g.prop("selected", d),
                d ? (g.attr("data-sortindex", b.sortIndex),
                    b.sortIndex++) : g.removeAttr("data-sortindex"))
        })
    }
    function i(a, b) {
        ...
        b.selectedElements = 0,
            ...
            b.element.find("option").each(function(c, d) {
                ...
                e.prop("selected") ? (b.selectedElements++,
                    b.elements.select2.append(e.clone(!0).prop("selected", e.data("_selected")))) : b.elements.select1.append(e.clone(!0).prop("selected", e.data("_selected")))
            }),
        b.settings.showFilterInputs && (l(b, 1),
            l(b, 2)),
            j(b)
    }
    function l(b, c) {
    ...
    function q(b) {
        "all" !== b.settings.preserveSelectionOnMove || b.settings.moveOnSelect ? "moved" !== b.settings.preserveSelectionOnMove || b.settings.moveOnSelect || m(b, 1) : (m(b, 1),
            ...
            k(b),
            f(b),
            b.settings.sortByInputOrder ? n(b.elements.select2) : o(b.elements.select2)
    }
    function r(b) {
    ...
    function s(b) {
        "all" !== b.settings.preserveSelectionOnMove || b.settings.moveOnSelect ? "moved" !== b.settings.preserveSelectionOnMove || b.settings.moveOnSelect || m(b, 1) : (m(b, 1),
            ...
            b.element.find("option").each(function(c, d) {
                var e = a(d);
                e.data("filtered1") || (e.prop("selected", !0),
    ...
    function u(a) {
        a.elements.form.submit(function(b) {
            a.elements.filterInput1.is(":focus") ? (b.preventDefault(),
                a.elements.filterInput1.focusout()) : a.elements.filterInput2.is(":focus") && (b.preventDefault(),
    ...
    e.prototype = {
        ...
        "setHelperSelectNamePostfix": function(a, b) {
            return this.settings.helperSelectNamePostfix = a,
                a ? (this.elements.select1.attr("name", this.originalSelectName + a + "1"),
        ...
        "setNonSelectedFilter": function(a, b) {
            return this.settings.showFilterInputs ? (this.settings.nonSelectedFilter = a,
                this.elements.filterInput1.val(a),
            b && k(this),
                this.element) : void 0
        },
        "setSelectedFilter": function(a, b) {
            return this.settings.showFilterInputs ? (this.settings.selectedFilter = a,
        ...
        "setSortByInputOrder": function(a, b) {
            return this.settings.sortByInputOrder = a,
            b && k(this),
                this.element
        },
