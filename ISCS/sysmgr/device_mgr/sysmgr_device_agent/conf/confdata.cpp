...
QList<KeyValue *> *ConfData::loadConf()
{
    char* iscsHome;
    char filePath[1024];
    FILE* fp;
...
int ConfData::saveConf(QList<KeyValue *> *keyValues)
{
    char* iscsHome;
    char filePath[1024];
    FILE* fp;
...
const char *ConfData::getValueByKey(const char *key)
{
